...
/**
 * Class LatitudePayPlaceOrderCest
...
class LatitudePayPlaceOrderCest
{
     ...
     * @throws Exception
     */
    public function iCanAddProductToCart($I, $scenario)
    {
     ...
     * @throws Exception
     */
    public function iCanPlaceOrderWithTotalAmountGreaterThanMinimumAmount($I, $scenario)
    {
        $this->doCheckout($I);
        $this->doFullRefund($I);
    }
     ...
     * @param $scenario
     */
    public function iCanNotPlaceWithTotalAmountLessThanMinimumAmount($I, $scenario)
    {
