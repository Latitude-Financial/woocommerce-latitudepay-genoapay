<?php
    ...
    $paddings = $gateway->get_id() == "latitudepay" ? "padding-right: 15px; max-width: 150px; padding-bottom: 7px; padding-top: 10px;" : "padding-right: 15px; max-width: 125px; padding-bottom: 7px;";
